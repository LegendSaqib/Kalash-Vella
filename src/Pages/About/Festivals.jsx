           ...
           <div className=" flex items-center w-[195px] md:w-[290px] lg:w-[340px] 2xl:w-[460px] border-2 border-transparent border-l-[#B36228] rounded-lg ">
            ...
            <div className="flex flex-col md:flex-row w-full gap-2 2xl:gap-5">
              ...
              <div className="w-full md:w-[33%] flex flex-col items-center border border-[#956928]">
                  ...
                  <p className="text-justify text-[10px] lg:text-sm 2xl:text-2xl p-2 md:p-5">In August, Uchal celebrates the harvest of wheat and barley. Villagers wear their finest clothes, sing traditional songs, and dance late into the night. It’s a time of gratitude — a lively tribute to the bounty of the land.</p>
              </div>
              <div className="w-full md:w-[33%] flex flex-col items-center border border-[#956928]">
                  ...
                  <p className="text-justify text-[10px] lg:text-sm 2xl:text-2xl p-2 md:p-5">Held in May, Chilimjusht welcomes the arrival of spring. Families decorate their homes with wildflowers, share dairy dishes, and thank the gods for new life and growth. It’s the season of joy, renewal, and community.</p>
              </div>
            </div>
        </div>
        </>
